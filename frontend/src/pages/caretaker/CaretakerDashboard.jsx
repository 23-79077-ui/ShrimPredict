      ...
      <div className="row g-3 mb-4">
        <div className="col-sm-6 col-xl-3">
          <div className="card stat-card-cyan shadow-sm rounded-4 p-4 h-100 position-relative overflow-hidden transition-all hover-shadow">
            ...
            <h3 className="fw-extrabold mb-2">{assignedPonds.length}</h3>
        ...
        <div className="col-sm-6 col-xl-3">
          <div className="card stat-card-green shadow-sm rounded-4 p-4 h-100 position-relative overflow-hidden transition-all hover-shadow">
            <div className="d-flex align-items-center justify-content-between mb-3">
              <span className="text-muted small fw-semibold pt-0.5">Today's Logs</span>
              <div className="rounded-3 p-2.5 bg-success bg-opacity-10 text-success fs-5">
                <FaUtensils />
              </div>
            </div>
            <h3 className="fw-extrabold mb-2">{filteredTodayRecords.length}</h3>
        ...
        <div className="col-sm-6 col-xl-3">
          <div className="card stat-card-purple shadow-sm rounded-4 p-4 h-100 position-relative overflow-hidden transition-all hover-shadow">
            <div className="d-flex align-items-center justify-content-between mb-3">
              <span className="text-muted small fw-semibold pt-0.5">Total Feed Today</span>
              <div className="rounded-3 p-2.5 bg-info bg-opacity-10 text-info fs-5">
                <FaCheckCircle />
              </div>
            </div>
            <h3 className="fw-extrabold mb-2">{totalAmountToday.toFixed(1)} <small className="fs-6 text-muted fw-normal">kg</small></h3>
            <span className="text-muted extra-small d-block pb-0.5">{currentScope}</span>
          </div>
        </div>
        ...
        <div className="col-sm-6 col-xl-3">
          <div className="card stat-card-orange shadow-sm rounded-4 p-4 h-100 position-relative overflow-hidden transition-all hover-shadow">
            <div className="d-flex align-items-center justify-content-between mb-3">
              <span className="text-muted small fw-semibold pt-0.5">Feeding Schedule</span>
              <div className="rounded-3 p-2.5 bg-warning bg-opacity-10 text-warning fs-5">
                <FaClock />
              </div>
            </div>
            <div className="caretaker-progress-line mb-2">
              <h3 className="fw-extrabold d-inline me-2 mb-0">{feedingCompletion}%</h3>
            ...
            <span className="text-muted extra-small d-block pb-0.5">Daily target progress</span>
          </div>
        </div>
      </div>
